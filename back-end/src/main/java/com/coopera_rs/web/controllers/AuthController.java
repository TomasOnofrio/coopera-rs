...
import com.coopera_rs.web.dto.ResetPasswordRequestDTO;
...
public class AuthController {
    ...
    public ResponseEntity<Boolean> resetPassword(@RequestBody @Valid ResetPasswordRequestDTO request) {
        boolean success = authService.resetPassword(request.getToken(), request.getNewPassword(), request.getConfirmPassword());
